...
\begin{notacion}
    Para cualesquiera arcos $\alpha,\beta$, notaremos que $\alpha,\beta\in \Omega(X;x,y)$ para indicar que tienen extremos iguales, es decir
    \begin{equation*}
        \alpha(0) = \beta(0) = x \hspace{1cm} \text{ y } \hspace{1cm} \alpha(1) = \beta(1) = y
    \end{equation*}
\end{notacion}
...
\begin{lema}
    ...
    \begin{proof}\
        \begin{enumerate}
            ...
            Como $\alpha\in \Omega(X;x,y)$ tenemos que $\alpha(s)\in X$ para todo $s\in [0,1]$. Además se verifica que
            \begin{gather*}
                H(s,0) = \alpha(s)=H(s,1)\\
