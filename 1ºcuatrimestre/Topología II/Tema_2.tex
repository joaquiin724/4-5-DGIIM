...
\begin{teo}
    ...
    % //TODO: mirar si queda igual que con gather

    \[
    \begin{tikzcd}
        & R \arrow[d, "p"] \\
        X \arrow[r, "f"'] \arrow[ur, dashed, "\hat{f}"] & B
    \end{tikzcd}
    \]
...
\begin{ejemplo}
    ...
    \[
    \begin{tikzcd}
        & \mathbb{S}^1 \times \mathbb{R} \arrow[d, "p"] \\
        \mathbb{S}^1 \arrow[ur, dashed, "\hat{f}_1\text{, }\hat{f}_2"] \arrow[r, "f_1\text{, }f_2"'] & \mathbb{S}^1 \times \mathbb{R}
    \end{tikzcd}
    \]
    ...
    \begin{gather*}
        f_{1*}([\alpha]) = [f_1 \circ \alpha] = [\beta] \Rightarrow
...
\begin{ejemplo}\
    ...
    \begin{tikzcd}[column sep=large]
        R \arrow[d, "p"'] & r_0 \arrow[d, maps to] & \{0\} \arrow[d, maps to] & \mathbb{R}\mathrm{P}^n \arrow[d, "\mathrm{Id}"'] & x_0 \arrow[d, maps to, "\mathrm{Id}"'] & \pi_1(\mathbb{R}\mathrm{P}^n, x_0) \arrow[d, "\mathrm{Id}_*"] \\
        \mathbb{R}\mathrm{P}^n & x_0 & \{0\} & \mathbb{R}\mathrm{P}^n & x_0 & \pi_1(\mathbb{R}\mathrm{P}^n, x_0)
    \end{tikzcd}
    \]
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        Tenemos que $B$ es simplemente conexo por ser contráctil pero no es localmente simplemente conexo. Esto se debe a que si tomamos el punto $b=(0,\nicefrac{3}{2})$ podemos tomar un abierto de la siguiente forma:
        \begin{gather*}
        ...
        Y de forma análoga al ejemplo anterior, no podremos tomar ningún entorno de $b$ simplemente conexo ya que este contendrá un trozo de cono cortado, que será un cilindro topológico y por tanto no será simplemente conexo.
    \end{enumerate}
\end{ejemplo}
