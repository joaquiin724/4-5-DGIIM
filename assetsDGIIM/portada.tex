\newcommand{\assetsPath}{/home/joaquiin_724/Documentos/ERASMUS/assetsDGIIM}
...
\newcommand{\portadaBase}[8]{
    ...
    \begin{figure}[p]
        ...
        \includegraphics[width=\paperwidth, keepaspectratio]{\assetsPath/#1}
        ...
        \node[anchor=south west, inner sep=3cm] at (current page.south west) {
            \begin{minipage}{0.5\paperwidth}
                \href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{
                    \includegraphics[height=2cm]{\assetsPath/Licencia.png}
                }\vspace{1cm}\\
